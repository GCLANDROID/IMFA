...
import com.genius.imfa.wfh.WFHApproverFragment;

import java.io.IOException;
import java.util.ArrayList;

public class WFHApproverAdapter extends RecyclerView.Adapter<WFHApproverAdapter.MyViewHolder>{
    private static final String TAG = "OtherApproverAdapter";
    Context context;
    Fragment fContext;
    ArrayList<OtherApproverModel> otherApproverList;

    public WFHApproverAdapter(Context context, Fragment fContext, ArrayList<OtherApproverModel> otherApproverList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.llTick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otherApproverModel.isSelected()) {
                    ...
                    ((WFHApproverFragment) fContext).updateAttendanceStatus(position, true );
                } else {
                    ...
                    holder.imgTick.setVisibility(View.GONE);
                    ((WFHApproverFragment) fContext).updateAttendanceStatus(position, false);
        ...
        holder.lnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((WFHApproverFragment) fContext).deleteFunction(otherApproverList.get(position).getAID());
            }
        });
