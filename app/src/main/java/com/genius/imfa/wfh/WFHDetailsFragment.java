...
import com.genius.imfa.adapter.WFHDetailsAdapter;
...
public class WFHDetailsFragment extends Fragment {
    ...
    WFHDetailsAdapter adjustmentDetailsAdapter;
    ...
    private void getReport(JSONObject object) {
        ...
        AndroidNetworking.post(Api.sGetwfhAdjustmentDetailsforGrid)
    ...
    private void setAdapter() {
        adjustmentDetailsAdapter = new WFHDetailsAdapter(getActivity(),adjustmentList, WFHDetailsFragment.this);
